...
int main ()  {
    ...
    printf("\n\nUNIT TEST 5 -- mineEffect() Test commencing!\n\n");
    printf("---------UNIT TEST 5A-------:\n");
    G.handCount[0] = 3;
    G.hand[0][0] = mine;
    G.hand[0][1] = copper;
    ...
    preCoins = G.coins;
    test = mineEffect(1, silver, &G, 0);  //call function
    ...
    preActions = G.numActions;
    preCoins = G.coins;
    test = mineEffect(1, tribute, &G, 0);  //call function
    ...
    preActions = G.numActions;
    preCoins = G.coins;
    test = mineEffect(1, 75, &G, 0);  //call function
    ...
    printf("\nUNIT TEST 5 -- mineEffect() Test completed!\n\n");
    return 0;
}