...
int main ()  {
    ...
    printf("\n\nUNIT TEST 2 -- minionEffect() Test commencing!\n\n");
    printf("---------UNIT TEST 2A-------:\n");
    G.handCount[0] = 3;
    G.hand[0][0] = copper;
    G.hand[0][1] = copper;
    ...
    test = minionEffect(1, 0, &G, 2);  //call function
    ...
    test = minionEffect(0, 1, &G, 2);  //call function
    ...
    preCoins = G.coins;     //save coin amt before function call
    preActions = G.numActions;     //save numActions amt before function call
    test = minionEffect(0, 1, &G, 4);  //call function
    ...
    printf("\nUNIT TEST 2 -- minionEffect() Test completed!\n\n");
    return 0;
