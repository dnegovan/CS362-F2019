...
int main ()  {
    ...
    //--------------------------------------------------------------------------
    //TEST 3: RANDOM TESTING tributeCard()
    //--------------------------------------------------------------------------
    printf("\n\nUNIT TEST 3 -- tributeCard() Test commencing!\n\n");
    ...
    for (int i = 0; i < 10000; i++) {
        ...
        //CALL FUNCTION
        test = tributeCard(&G, nextPlayer, G.whoseTurn, tributeRevealedCards);  //call function
        ...
        //otherwise check that both cards had their Card
        else {
            for (int i = 0; i < 2; i++) {
                //Treasure Card
    ...
    printf("\nUNIT TEST 3 -- tributeCard() Test completed!\n\n");
    return 0;
