...
int main ()  {
    ...
    printf("\n\nUNIT TEST 3 -- ambassadorCard() Test commencing!\n\n");
    printf("---------UNIT TEST 3A-------:\n");
    G.handCount[0] = 3;
    G.hand[0][0] = mine;
    ...
    test = ambassadorCard(1, 0, G.whoseTurn, 2, &G);  //call function
    ...
    test = ambassadorCard(1, 1, G.whoseTurn, 2, &G);  //call function
    ...
    preSupply = G.supplyCount[mine];
    test = ambassadorCard(1, 2, G.whoseTurn, 3, &G);  //call function
    ...
    preSupply = G.supplyCount[mine];
    test = ambassadorCard(1, -1, G.whoseTurn, 3, &G);  //call function
    ...
    printf("\nUNIT TEST 3 -- ambassadorCard() Test completed!\n\n");
    return 0;
